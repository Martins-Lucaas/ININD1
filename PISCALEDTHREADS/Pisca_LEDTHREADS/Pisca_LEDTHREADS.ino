...
void ledBlink() {
  while (true) {
    ...
    delay(5000);                    // Mantém o LED ligado por 250 ms
    digitalWrite(ledPin, LOW);    // Desliga o LED
    delay(5000);                    // Mantém o LED desligado por 250 ms
  }
}
...
void setup() {
  ...
  ledThread.setInterval(5000); // Define o intervalo de execução para 500 ms
